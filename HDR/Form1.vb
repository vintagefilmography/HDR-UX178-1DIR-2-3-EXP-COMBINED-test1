        ...
        If ImgSaveToggle = 1 Then
            ...
            If ImageCount > 0 Then
                ...
                If SequenceCount = 1 Then
                    If Exp_2_3 = 3 Then
                        ExpValue = ExpValue * (2 ^ (Increment / 2))

                    Else
                        ExpValue = ExpValue / (2 ^ (Decrement / 2))
                    End If
                End If
                ...
                If SequenceCount = 3 Then
                    'Threading.Thread.Sleep(50)
                    If Exp_2_3 = 3 Then
                        ExpValue = ExpValue / (2 ^ (Increment + (Decrement / 2)))
                    Else
                        ExpValue = ExpValue * (2 ^ (Decrement / 2))
                    End If
                    Exposure_Abs(IcImagingControl2, ExpValue)
                ...
                If SequenceCount = 4 Then
                    'Threading.Thread.Sleep(50)
                    If Exp_2_3 = 3 Then
                        ExpValue = ExpValue / (2 ^ ((Increment / 2) + (Decrement / 2)))
                    Else
                        ExpValue = ExpValue * (2 ^ (Decrement / 2))
                    End If
                    Exposure_Abs(IcImagingControl2, ExpValue)
